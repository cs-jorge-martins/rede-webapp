module.exports = function(grunt) {
    ...
    grunt.registerTask('local', ['concat', 'ngconstant:local', 'serve']);
    grunt.registerTask('dev', ['concat', 'ngconstant:development', 'serve']);
    grunt.registerTask('hml', ['concat', 'ngconstant:homologation', 'serve']);
    grunt.registerTask('prod', ['concat', 'ngconstant:production']);
};
